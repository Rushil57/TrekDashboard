...
namespace AnalyticsAPI.Utils
{
    public class JilFormatter : MediaTypeFormatter
    {
        ...
        public JilFormatter()
        {
            _jilOptions = new Options(dateFormat: DateTimeFormat.ISO8601, unspecifiedDateTimeKindBehavior: UnspecifiedDateTimeKindBehavior.IsUTC);
